URL : [Flag Hunters](https://learn.cylabacademy.org/library/472?category=3&difficulty=1&page=1)
...
```
A brief of how this software works. The reader function has 2 parts, get the lyrics and print out the lyrics. For getting the lyrics, it will read and store 
